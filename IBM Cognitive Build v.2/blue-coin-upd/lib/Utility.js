...
class Utility{
  ...
  static privEncryptASYM(originMsg, publicKey){
    var buffer = new Buffer.from(originMsg, "base64");
    var encMsg = crypto.privateEncrypt(publicKey, buffer);
    console.log("\nEncrypted with public key : ", encMsg.toString("utf8"));
    return encMsg.toString("utf8");
  }
